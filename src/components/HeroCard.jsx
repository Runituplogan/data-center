...
const HeroCard = () => {
  return (
    <div className="pt-20 px-4 sm:px-10 md:px-20 lg:px-28 relative h-[100vh] flex flex-col justify-center items-center">
      <div className="absolute inset-0 bg-black opacity-55 z-[2]"></div>
      <div className="relative z-10 self-start mt-0 md:mt-20">
        <YDivMotion>
          <h1 className="gilroy-bold w-full text-left font-bold text-white text-4xl md:text-5xl lg:text-6xl xl:text-7xl">
            Datacenter Talent.
          </h1>
        ...
        <YDivMotion delay={0.7}>
          <p className="text-left gilroy-bold w-full text-white font-medium pb-40 text-base lg:text-lg xl:text-xl mt-5 md:mt-8">
