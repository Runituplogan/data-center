...
const Navbar = ({ onOpen }) => {
  return (
    <nav className="w-full flex justify-between items-center gap-3 fixed md:absolute top-0 right-0 left-0 px-5 py-3 md:py-8 md:px-20 md:shadow-none shadow-md z-20 bg-white z-50">
